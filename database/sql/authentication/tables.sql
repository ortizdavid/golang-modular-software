...
('authentication.users.getActiveUsers', 'Get All Active Users', 'Handles the retrieval of all active users.'),
('authentication.users.getInactiveUsers', 'Get All Inactive Users', 'Handles the retrieval of all inactive users.'),
('authentication.users.getOnlineUsers', 'Get All Online Users', 'Handles the retrieval of all online users.'),
('authentication.users.getOfflineUsers', 'Get All Offline Users', 'Handles the retrieval of all offline users.'),
