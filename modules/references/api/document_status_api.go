...
func NewDocumentStatusApi(db *database.Database) *DocumentStatusApi {
...
func (api *DocumentStatusApi) Routes(router *fiber.App, db *database.Database) {
	group := router.Group("/api/references/document-statuses")
...
func (api *DocumentStatusApi) getAll(c *fiber.Ctx) error {
...
func (api *DocumentStatusApi) add(c *fiber.Ctx) error {
...
func (api *DocumentStatusApi) edit(c *fiber.Ctx) error {
	...
	msg := "Updated document status '"+request.StatusName+"' successfully"
	api.infoLogger.Info(c, msg)
	return c.JSON(fiber.Map{"message": msg})
}

func (ctrl *DocumentStatusApi) getByUniqueId(c *fiber.Ctx) error {
	id := c.Params("id")
...
func (ctrl *DocumentStatusApi) getByCode(c *fiber.Ctx) error {
	code := c.Params("code")
...
func (ctrl *DocumentStatusApi) getByName(c *fiber.Ctx) error {
	name := c.Params("name")
...
func (api *DocumentStatusApi) remove(c *fiber.Ctx) error {
	id := c.Params("id")
	...
	msg := "Removed document status '"+status.StatusName+"'"
	api.infoLogger.Info(c, msg)
	return c.JSON(fiber.Map{"message": msg})
}

func (api *DocumentStatusApi) getAllNotPaginated(c *fiber.Ctx) error {
