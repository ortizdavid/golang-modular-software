...
func NewWorkflowStatusApi(db *database.Database) *WorkflowStatusApi {
	return &WorkflowStatusApi{
...
func (api *WorkflowStatusApi) Routes(router *fiber.App, db *database.Database) {
	group := router.Group("/api/references/workflow-statuses")
...
func (api *WorkflowStatusApi) getAll(c *fiber.Ctx) error {
...
func (api *WorkflowStatusApi) add(c *fiber.Ctx) error {
...
func (api *WorkflowStatusApi) edit(c *fiber.Ctx) error {
	...
	msg := "Updated workflow status '"+request.StatusName+"' successfully"
	api.infoLogger.Info(c, msg)
	return c.JSON(fiber.Map{"message": msg})
}

func (ctrl *WorkflowStatusApi) getByUniqueId(c *fiber.Ctx) error {
	id := c.Params("id")
...
func (ctrl *WorkflowStatusApi) getByCode(c *fiber.Ctx) error {
	code := c.Params("code")
...
func (ctrl *WorkflowStatusApi) getByName(c *fiber.Ctx) error {
	name := c.Params("name")
...
func (api *WorkflowStatusApi) remove(c *fiber.Ctx) error {
	id := c.Params("id")
	...
	msg := "Removed workflow status '"+status.StatusName+"'"
	api.infoLogger.Info(c, msg)
	return c.JSON(fiber.Map{"message": msg})
}

func (api *WorkflowStatusApi) getAllNotPaginated(c *fiber.Ctx) error {
