...
func (s *ModuleFlagService) ManageModuleFlags(ctx context.Context, requests []entities.ManageModuleFlagRequest) error {
	...
	for _, req := range requests {
		...
		if err != nil {
			return apperrors.NotFoundError("module flag not found")
		}
	...
	if err := s.repository.UpdateBatch(ctx, moduleFlags); err != nil {
		return apperrors.InternalServerError("error while updating module flags: " + err.Error())
	}
	return nil
}
...
func (s *ModuleFlagService) GetAllPaginated(ctx context.Context, fiberCtx *fiber.Ctx, params helpers.PaginationParam) (*helpers.Pagination[entities.ModuleFlagData], error) {
	...
	if err != nil {
		return nil, apperrors.NotFoundError("No module flags found")
	}
...
func (s *ModuleFlagService) GetByUniqueId(ctx context.Context, uniqueId string) (entities.ModuleFlagData, error) {
	...
	if err != nil {
		return entities.ModuleFlagData{}, apperrors.NotFoundError("module not found")
	}
	return module, nil
}
...
func (s *ModuleFlagService) GetByModuleCode(ctx context.Context, code string) (entities.ModuleFlagData, error) {
	...
	if err != nil {
		return entities.ModuleFlagData{}, apperrors.NotFoundError("module flag not found")
	}
