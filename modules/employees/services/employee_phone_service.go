...
func (s *EmployeePhoneService) Create(ctx context.Context, fiberCtx *fiber.Ctx, request entities.CreateEmployeePhoneRequest) error {
	...
	if exists {
		return apperrors.BadRequestError("employee phone already exists for employee: " + employee.FirstName)
	}
	...
	if err != nil {
		return apperrors.InternalServerError("error while creating employee phone: " + err.Error())
	}
	return nil
}
...
func (s *EmployeePhoneService) Update(ctx context.Context, employeePhoneId int64, request entities.UpdateEmployeePhoneRequest) error {
	...
	if err != nil {
		return apperrors.NotFoundError("employee phone not found")
	}
	...
	if err != nil {
		return apperrors.InternalServerError("error while updating employee phone: " + err.Error())
	}
	return nil
}
...
func (s *EmployeePhoneService) GetAllPaginated(ctx context.Context, fiberCtx *fiber.Ctx, params helpers.PaginationParam, employeeId int64) (*helpers.Pagination[entities.EmployeePhoneData], error) {
	...
	if err != nil {
		return nil, apperrors.NotFoundError("No employee phones found for employee: ")
	}
...
func (s *EmployeePhoneService) GetAll(ctx context.Context, employeeId int64) ([]entities.EmployeePhoneData, error) {
	...
	if err != nil {
		return nil, apperrors.NotFoundError("No employee phones found")
	}
...
func (s *EmployeePhoneService) GetByUniqueId(ctx context.Context, uniqueId string) (entities.EmployeePhoneData, error) {
	...
	if err != nil {
		return entities.EmployeePhoneData{}, apperrors.NotFoundError("employee phone not found")
	}
...
func (s *EmployeePhoneService) GetAllByEmployeeUniqueId(ctx context.Context, uniqueId string) ([]entities.EmployeePhoneData, error) {
	...
	if err != nil {
		return nil, apperrors.NotFoundError("employee phone not found")
	}
	return employeePhones, nil
}
...
func (s *EmployeePhoneService) Remove(ctx context.Context, uniqueId string) error {
	...
	if err != nil {
		return apperrors.InternalServerError("error while removing employee phone: " + err.Error())
	}
	return nil
}
