...
func (s *PolicyService) Create(ctx context.Context, request entities.CreatePolicyRequest) error {
	...
	if exists {
		return apperrors.BadRequestError("Policy already exists for company " + company.CompanyName)
	}
	...
	if err != nil {
		return apperrors.InternalServerError("error while creating policy: " + err.Error())
	}
	return nil
}
...
func (s *PolicyService) Update(ctx context.Context, uniqueId string, request entities.UpdatePolicyRequest) error {
	...
	if err != nil {
		return apperrors.NotFoundError("policy not found")
	}
	...
	if err != nil {
		return apperrors.InternalServerError("error while updating policy: " + err.Error())
	}
	return nil
}
...
func (s *PolicyService) GetAllPaginated(ctx context.Context, fiberCtx *fiber.Ctx, params helpers.PaginationParam) (*helpers.Pagination[entities.PolicyData], error) {
	...
	if err != nil {
		return nil, apperrors.NotFoundError("No policies found")
	}
...
func (s *PolicyService) GetByUniqueId(ctx context.Context, uniqueId string) (entities.PolicyData, error) {
	...
	if err != nil {
		return entities.PolicyData{}, apperrors.NotFoundError("policy not found")
	}
	return policy, nil
}
...
func (s *PolicyService) GetPolicyById(ctx context.Context, policyId int) (entities.Policy, error) {
	...
	if err != nil {
		return entities.Policy{}, apperrors.NotFoundError("policy not found")
	}
	return policy, nil
}
...
func (s *PolicyService) Remove(ctx context.Context, uniqueId string) error {
	...
	if err != nil {
		return apperrors.InternalServerError("error while removing policy: " + err.Error())
	}
	return nil
}
