...
func (s *CompanyService) Create(ctx context.Context, request entities.CreateCompanyRequest) error {
	...
	if err != nil {
		return apperrors.InternalServerError("error while creating company: " + err.Error())
	}
	return nil
}
...
func (s *CompanyService) Update(ctx context.Context, uniqueId string, request entities.UpdateCompanyRequest) error {
	...
	if err != nil {
		return apperrors.InternalServerError("error while updating company: " + err.Error())
	}
	return nil
}
...
func (s *CompanyService) GetAllPaginated(ctx context.Context, fiberCtx *fiber.Ctx, params helpers.PaginationParam) (*helpers.Pagination[entities.CompanyData], error) {
	...
	if err != nil {
		return nil, apperrors.NotFoundError("No companies found")
	}
...
func (s *CompanyService) GetCurrent(ctx context.Context) (entities.CompanyData, error) {
	...
	if err != nil {
		return entities.CompanyData{}, apperrors.NotFoundError("company not found")
	}
	return company, nil
}
